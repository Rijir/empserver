...
version := $(shell set -x; cd $(srcdir) && build-aux/git-version-gen /dev/null)
else
include $(srcdir)/sources.mk
version := $(shell cat .tarball-version || echo "UNKNOWN")
endif
...
distclean := $(ac) $(addprefix $(srcdir)/, $(mk))
# Distributed by dist-source from $(srcdir):
...
dist-source: $(addprefix $(srcdir)/, $(mk))
endif
